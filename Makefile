LANGUAGE_NAME := tree-sitter-bidhuscript
HOMEPAGE_URL := https://github.com/therealsoutrikdas/bidhuscrip
VERSION := 1.0.0
DESCRIPTION := This is a parser for BidhuScript
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/bidhuscript '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/bidhuscript
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/bidhuscript
